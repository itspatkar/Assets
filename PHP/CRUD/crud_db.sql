...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 10:09 AM
...
INSERT INTO `certificates` (`cert_name`, `email`) VALUES
('wallhaven-6oqdkq.png', 'mandar@email.com'),
('wallhaven-76kkeo.jpg', 'mandar@email.com'),
('wallhaven-435zgy.jpg', 'mandar@email.com'),
('face.jpg', 'reshma@mail.com');
...
(1624, 'Mumbai', 'Maharashtra'),
(1625, 'Mumbai', 'Maharashtra');
...
INSERT INTO `education` (`email`, `education_name`, `year_of_completion`) VALUES
('mandar@email.com', 'HSC', 2019),
('mandar@email.com', 'BE Computer Engineering', 2023),
('reshma@mail.com', 'BA Arts', 2022);
...
INSERT INTO `employee` (`employee_id`, `name`, `dob`, `gender`, `state`, `city`, `profilepic`, `profession`, `email`, `mobile`) VALUES
(21, 'Mandar Patkar', '2023-11-01', 'Male', 'Arunachal Pradesh', 'Nalbari', '1282788.jpg', 'Self-Employed', 'mandar@email.com', '1231231231'),
(23, 'Reshma Patkar', '2023-11-23', 'Female', 'Assam', 'Adoni', '1282788.jpg', 'Salaried', 'reshma@mail.com', '1231231231');
...
INSERT INTO `salaried` (`email`, `company_name`, `job_date`) VALUES
('reshma@mail.com', 'JK', '2023-11-06');
...
--
-- Dumping data for table `selfemployed`
--

INSERT INTO `selfemployed` (`email`, `business_name`, `business_location`) VALUES
('mandar@email.com', 'Mandar LLC', 'Mumbai');
...
ALTER TABLE `employee`
  ...
  ADD UNIQUE KEY `email` (`email`,`mobile`) USING HASH;
...
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `skills`
--
ALTER TABLE `skills`
  MODIFY `skill_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
